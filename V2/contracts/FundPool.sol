...
contract FundPool{
    ...
    /// @dev 只能允许vote合约调用
    /// @param 锁定的地址
    function unsafe_lockFnd(address who,uint256 clearingProposalIndex) public{
        //调用者必须是vote合约
    ...
    /// @param 解锁的地址
    function unsafe_unLockFnd(address who,uint256 clearingProposalIndex) public{
        //调用者必须是vote合约
        require(msg.sender == address(vote),"sender should be vote contract");
    ...
    /// @param 清退的股份数量
    function unsafe_clearing(uint256 clearingShares,uint256 clearingProposalIndex)  public{
        //调用者必须是vote合约
        require(msg.sender == address(vote),"sender should be vote contract");
    ...
    /// @notice 获取清退的钱
    function unsafe_getClearingValue(address who,uint256 clearingProposalIndex) public{
        //调用者必须是vote合约
        require(msg.sender == address(vote),"sender should be vote contract");
